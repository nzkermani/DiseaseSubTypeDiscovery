...
write.csv(file = 'C:/Users/nz1413/Desktop/AnalysisTag/code/result2classDistinction.txt'
          , FinalResult)
...
write.csv(file = 'C:/Users/nz1413/Desktop/AnalysisTag/Final/data/result2classDistinctionBenferoni.txt'
          , FinalResult)
...
{ 
  ...
  quantTemp = quantile(FinalResult[,i], 0.95)
  FinalSelection[(floor(i/2)+1),] = as.numeric(c(FinalResult[,i]>= quantTemp & FinalResult[,(i+1)]<= 0.01))
}
library(gtools)
foldChange = 1:nvars
for (i in 1:nvars)
{
  foldChange[i] = foldchange(dataTAC3[which(labelTAC3==3),i],
                             dataTAC3[which(labelTAC3==4),i] )
}
finalResultSelectionAndFoldChange = cbind(t(FinalSelection), foldChange)
write.csv(file = 'C:/Users/nz1413/Desktop/AnalysisTag/Final/data/FoldChangeSelectionresult2classDistinctionBenferoni.txt'
